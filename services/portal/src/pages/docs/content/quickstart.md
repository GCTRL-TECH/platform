...
- **In the UI:** use **Upload / Import** to drop a **PDF**, a screenshot or a whiteboard photo (or paste text). KEX extracts entities and relations; open the **Visual Explorer** or **Wiki** to see the graph, then ask questions in **Talk-to-Graph**.
- **From the API:**
...
4. Ask your agent: *"Ingest this PDF and show me the knowledge graph."* Agents can call `ingest_file` directly - for PDFs, Office files and images alike - so they don't need the UI upload step at all.
