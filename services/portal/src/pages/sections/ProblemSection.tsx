  ...
  return (
    <section className="relative bg-[#020617] px-6 py-28">
      <div className="mx-auto max-w-6xl">
        ...
        {/* The thesis — where this is heading, and why sovereignty wins */}
        <div className="reveal mx-auto mt-14 max-w-3xl rounded-2xl border border-indigo-500/20 bg-indigo-500/[0.06] p-8 text-center">
          ...
          <p className="text-lg leading-relaxed text-slate-300">
            ...
            every employee, every agent session into one governed graph —{' '}
