-- Mark the migrations that have already-existing schema on the VPS
-- gctrl-app-db. Verified-present tables: messages, conversations, triggers,
-- users.default_ontology_id. Missing: licenses (15), text_chunks (18),
-- synced_to_license_api column (20), enum→text conversion (17),
-- ontology_scope→text (19). Those will run on next startup.
...
(16, 'conversations',           true, decode('8ef199da46db79a686c811048f7541796ace1cdd6f823276a7570a60ae06437de1e24d32556e3ce964d41727e47312f9','hex'), 0)
ON CONFLICT (version) DO NOTHING;

SELECT 'After insert' AS phase, version, description, success FROM _sqlx_migrations ORDER BY version;
